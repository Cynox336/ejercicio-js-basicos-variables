...
let historiaGato = "Mi gato se llama " + nombreGato + " tiene " + edadGato + " y pesa " + pesoGato + " kilos. Es de color " + colorGato + " y tiene una personalidad " + personalidadGato + ". Le encanta comer " + comidaFavorita + " y tiene " + numJuguetes + " juguetes diferentes. Necesita dormir al menos " + numHorasSueño + " horas al día." + "\nAhora mismo está jugando con su" + jugandoAhora + ". ¡Es un gato muy feliz!"; // modificar solamente  esta línea
